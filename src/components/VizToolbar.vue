  ...
  <div class="viz-toolbar">
    <div class="toolbar-row">
      ...
      <div class="toolbar-item">
        <label class="toolbar-label">Key</label>
        <el-select
      ...
      <!-- Channel selector -->
      <div class="toolbar-item">
        <label class="toolbar-label">Channels</label>
        <el-select
          ...
          style="width: 180px"
        >
          <el-option v-for="i in 28" :key="i - 1" :label="`ch${i - 1}`" :value="i - 1" />
        </el-select>
      </div>

      <!-- ROI inputs -->
      <div class="toolbar-item">
        <label class="toolbar-label">ROI</label>
